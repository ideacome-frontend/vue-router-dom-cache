...
var Views = {
  ...
  render: function render (_, ref) {
    ...
    var cache = parent._routerViewCache || (parent._routerViewCache = {});
    var vnodeCache = parent.$root['_vnodeCache'] || (parent.$root['_vnodeCache'] = []);
    var currentVnode;
    // determine current view depth, also check to see if the tree
    // has been toggled inactive but kept-alive.
    var depth = 0;
...
var HashHistory = /*@__PURE__*/(function (History$$1) {
  ...
  HashHistory.prototype.push = function push (location, direction, onComplete, onAbort) {
    var this$1 = this;
  ...
  HashHistory.prototype.replace = function replace (location, direction, onComplete, onAbort) {
    var this$1 = this;
